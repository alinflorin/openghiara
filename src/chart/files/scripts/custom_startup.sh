...
npx -y @1mcp/agent --config /etc/1mcp/mcp.json --enable-auth --instructions-template /etc/1mcp/instructions-template.md --port 9090 --host 0.0.0.0 -u $INGRESS_HOST --trust-proxy true &
